            ...
            <main className="flex-grow container mx-auto px-4 py-8">
                <Card>
                    ...
                    <CardContent className="space-y-6 text-muted-foreground prose dark:prose-invert max-w-none">
                        <p>Your privacy is important to us. It is Blogify's policy to respect your privacy regarding any information we may collect from you across our website, <a href="https://blogify.blog">blogify.blog</a>, and other sites we own and operate.</p>
                        
                        <h2 className="text-xl font-semibold text-foreground">1. Information We Collect</h2>
                        <p>We only ask for personal information when we truly need it to provide a service to you. We collect it by fair and lawful means, with your knowledge and consent. We also let you know why we’re collecting it and how it will be used.</p>
                        <p>The personal details which may be provided by You to Us via the Blogify Site are considered "User Information". This may include your name, email address, and other details you provide when you register, post content, or contact us.</p>
                        ...
                        <p>Blogify's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options.</p>
                        ...
                        <p>We reserve the right to change this privacy policy upon the posting of any altered privacy policy upon the Blogify Site.</p>
